...
import com.kidsboodle.teacher.data.model.homefragment.ExamListitems
...
interface ApiService {
    ...
    @GET("exam_type_crud/")
    suspend fun _getExamTypeList(@Header("Authorization") authToken:String, @Query("page_size") pageSize:Int): ExamListitems


    @GET("teacher_student_class_details_get/")
    suspend fun _getTeacherStudentList(@Header("Authorization") authToken:String): TeacherStudentClassListResponse
...
//    suspend fun _getTeacherHolidayList(@Header("Authorization") authToken:String,@Query("page_size") pageSize:Int): TeacherStudentClassListResponse
    ...
    suspend fun _getTeacherClassSectionList(@Header("Authorization") authToken:String,@Query("class") Class:String,@Query("session") session:String, @Query("page") page:Int, @Query("page_size") pageSize:Int): TeacherClassSectionListResponse

    @GET("teacher_all_announcement_list_get/")
    suspend fun _getAnnouncementHistoryList(@Header("Authorization") authToken:String,@Query("page") page:Int,@Query("page_size") pageSize:Int): AnnouncementHistoryItem
    ...
    @GET("teacher_student_grade_details/")
    suspend fun _getGrade(@Header("Authorization") authToken:String,@Query("page_size") pageSize:Int, @Query("exam") exam:String, @Query("scl_class") Class:String, @Query("cls_section") section:String, @Query("student_id") student_id:String): GetGradeResponse
