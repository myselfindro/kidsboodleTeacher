...
class MainRepository(private val apiHelper: ApiHelper) {
    ...
    suspend fun getExamTypeList(token: String, pageSize:Int) =
        apiHelper.getExamTypeList(token, pageSize)

    suspend fun getTeacherStudentList(token: String) =
        apiHelper.getTeacherStudentClassList(token)

    suspend fun getTeacherClassSectionList(authToken: String, Class: String, section: String, page: Int, pageSize: Int) =
        apiHelper.getTeacherClassSectionList(authToken, Class, section, page, pageSize)

    suspend fun getAnnouncementHistoryList(authToken: String, page:Int, pageSize:Int) =
        apiHelper.getAnnouncementHistoryList(authToken, page, pageSize)
    ...
    scl_class: String,
    cls_section: String,
    student_id:String) = apiHelper.getGrade(
        token,
        page_size,
        exam,
        scl_class,
