...
class AnnouncementDetailsViewModel(private val mainRepository: MainRepository) : ViewModel() {

    fun getAnnouncementList(token: String, Class: String, section: String, page: Int, pageSize:Int) =
